...
export const asyncRouterMap=[
    ...
    },
    {
        ...
        children:[
            ...
            { path: 'review-criterion', title: '评审标准', name: 'match-manage-review', icon: 'ios-list-box',component: resolve => { require(['@/views/match-manage/review.vue'], resolve); }}
    ...
    },
    {
        ...
        component: Main,
        children: [
            { path: 'audit', title: '材料审核', name: 'material-audit', icon: 'ios-list-box', component: resolve => { require(['@/views/material/audit.vue'], resolve);}},
            { path: 'upload', title: '材料上传', name: 'material-upload', icon: 'ios-list-box', component: resolve => { require(['@/views/material/upload.vue'], resolve);}}
        ] 
    }
];
