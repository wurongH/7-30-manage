        ...
        <Row>
            <Col span="24">
                <Card>
                    ...
                    <Row justify="start" style="margin-bottom:10px;margin-top: 30px;width: 1100px">
                        <Form :label-width="100" >
                            ...
                            <FormItem label="评审专家人数" prop="tutorCount">
                                <Input v-model="tutorCount" type="number" style="width: 150px" placeholder="请输入评审专家人数" />
                            </FormItem>
                            <div class="title">
                                <span>专家构成</span>
                            ...
                            <Row>
                                <Col span="6" v-for="(item, index) in tutorTypeCountJa" :key="index">
                                  <FormItem :label="item.typeName">
                                      <Input v-model="item.maxCount" type="number" :placeholder="'请输入'+item.typeName+'人数'"/>
                                  </FormItem>
                                </Col>
                            </Row>
    ...
    export default {
        ...
        methods:{
            ...
            saveReviewSetting(){
                ...
                var count = 0;
                this.tutorTypeCountJa.map(v =>{
                  count += ~~v.maxCount;
                })
                if(count > this.tutorCount){
                  this.$Message.error("专家类型的值不能大于评审专家人数");
                  return;
                }
