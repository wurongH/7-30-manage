    ...
    watch: {
  	...
  	data(){
        ...
        columns: [
          ...
          { key: 'typeName', title: '字段名', align: 'center', },
    ...
    computed: {
      ...
      del(id){
        this.$Modal.warning({
          ...
          content: '确定删除此字段吗？',
          onOk: _ =>{
            api(this, '/matchManage/delComTypeField', {
              id
            }, res => {
              if (res.code == 0) {
                this.$Message.success('删除成功');
                this.$root.app.$emit('updateProfessor')
              } else {
