  ...
  <Row>
    ...
    <Card>
          ...
          <Form :label-width="150" inline>
            <FormItem :label="item.fieldLabel" prop="sessionIndex" :key="index+item.id" v-for="(item,index) in PROJECT_FILE">
              <div class="uploadModel">
                ...
                <div class="upload">
                  <Upload action="/file/uploadFile" :on-success="uploadSuccess" :before-upload="()=>handleBeforeUpload(item)">
      ...
      <div class="common">
        ...
        <DatePicker :value="time" format="yyyy-MM-dd HH:mm:ss" type="datetimerange" @on-change="sendTimeChange" placeholder="请选择提交时间" style="width: 320px"></DatePicker>
      </div>
      <p class="bottom">
      ...
      <Modal v-model="newFieldShow" title="新增字段" :width="400">
      ...
      <Modal v-model="deleteFieldShow" title="删除字段" :width="600" :footer-hide="true">
        <Row justify="center">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      dictFileFormat(id) {
        api(this, '/project/dictFileFormat', {
          id: id
        }, res => {
          if (res.code == 0) {
